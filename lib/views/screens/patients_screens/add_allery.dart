...
class AddAlerrgy extends StatefulWidget {
  const AddAlerrgy({super.key, required this.uid});
  final String uid;
  @override
  State<AddAlerrgy> createState() => _AddAlerrgyState();
}

class _AddAlerrgyState extends State<AddAlerrgy> {
  DateTime _selectedDate = (DateTime.now());
  Future<void> uploadAllergy(Allergies aller) async {
  ...
  getDateFromUser() async {
    ...
    pickeddate != null
        ...
        : print('It\'s Null');
    date = DateFormat.yMd(_selectedDate).toString();
  }
}
